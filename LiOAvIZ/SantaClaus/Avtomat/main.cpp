...
int main()
{
	...
	int*** weightChildren = Make3dArrayFrom2d(children, CHILD_COUNT, CHILD_PRESENTS, 100);
	//Print3dArray(weightChildren, CHILD_COUNT, CHILD_PRESENTS);

	int*** weightPresents = Make3dArrayFrom2d(presents, PRESENTS_COUNT, PRESENTS_CHILD, 184);
